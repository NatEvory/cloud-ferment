...
export declare class UserPool extends AWSResource<UserPool_ResourceProperties> {
    constructor(name: string, properties: UserPool_ResourceProperties, dependsOn?: string[]);
}
