...
var ResolverRuleAssociation = /** @class */ (function (_super) {
    ...
    function ResolverRuleAssociation(name, properties, dependsOn) {
        return _super.call(this, name, properties, "AWS::Route53Resolver::ResolverRuleAssociation", dependsOn) || this;
    }
