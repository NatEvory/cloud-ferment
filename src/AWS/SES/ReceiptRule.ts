...
export class ReceiptRule extends AWSResource<ReceiptRule_ResourceProperties> {
	constructor(name:string,properties:ReceiptRule_ResourceProperties,dependsOn?:string[]){
		super(name,properties,"AWS::SES::ReceiptRule",dependsOn);
	}
}
