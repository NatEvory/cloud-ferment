...
export class JobDefinition extends AWSResource<JobDefinition_ResourceProperties> {
	constructor(name:string,properties:JobDefinition_ResourceProperties){
		super(name,properties,"AWS::Batch::JobDefinition");
	}
}
