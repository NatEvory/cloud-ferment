...
export class Method extends AWSResource<Method_ResourceProperties> {
	constructor(name:string,properties:Method_ResourceProperties,dependsOn?:string[]){
		super(name,properties,"AWS::ApiGateway::Method",dependsOn);
	}
}
...
export interface Method_ResourceProperties extends AWSResourceProperties {
	...
	RequestModels?:{[key:string]:AWSStringProperty};
...
export interface Method_MethodResponse {
	ResponseModels?:{[key:string]:AWSStringProperty};
...
export interface Method_Integration {
	...
	RequestParameters?:{[key:string]:AWSStringProperty};
	RequestTemplates?:{[key:string]:AWSStringProperty};
